...
fn main() -> anyhow::Result<()> {
    ...
    let input_sequence_2 = "The prime minister has announced a stimulus package which was widely criticized by the opposition as it would significantly increase the deficit.";
    let candidate_labels = &["politics", "economy"];
