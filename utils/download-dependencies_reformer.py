from transformers.configuration_reformer import REFORMER_PRETRAINED_CONFIG_ARCHIVE_MAP
from transformers.tokenization_reformer import PRETRAINED_VOCAB_FILES_MAP
...
config_path = REFORMER_PRETRAINED_CONFIG_ARCHIVE_MAP['google/reformer-crime-and-punishment']
vocab_path = PRETRAINED_VOCAB_FILES_MAP["vocab_file"]['google/reformer-crime-and-punishment']
weights_path = 'google/reformer-crime-and-punishment'

target_path = Path.home() / 'rustbert' / 'reformer-crime-punishment'
